...
training_data1=audioread('sample memos/01_train.wav');
training_data2=audioread('sample memos/02_train.wav');
training_data3=audioread('sample memos/03_train.wav');

%------------reading in the test data-----------------------------------
[testing_data1,Fs]=audioread('sample memos/01_test.wav');
testing_data2=audioread('sample memos/02_test.wav');
testing_data3=audioread('sample memos/03_test.wav');
